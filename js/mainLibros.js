...
function main() {
    ...
    despues.addEventListener("click", function () {
        ...
        inputNombreLibro.value = "Después";
        inputAutorLibro.value = "Stephen King";
    });
    ...
    laCiudadDeLosNictalopes.addEventListener("click", function () {
        ...
        inputNombreLibro.value = "La ciudad de los Nictálopes";
        inputAutorLibro.value = "Tanya Tynjälä";
    });
    ...
    baladaDePajarosCantoresYSerpientes.addEventListener("click", function () {
        ...
        inputNombreLibro.value = "Balada de pájaros cantores y serpientes";
        inputAutorLibro.value = "Suzanne Collins";
    });
    ...
    elQuintoDragon.addEventListener("click", function () {
        ...
        inputNombreLibro.value = "El quinto dragón";
        inputAutorLibro.value = "Paulina Aguilar Gutiérrez";
    });
    ...
    harryPotterII.addEventListener("click", function () {
        ...
        inputNombreLibro.value = "Harry Potter y la cámara secreta";
        inputAutorLibro.value = "J. K. Rowling";
    });
    ...
    harryPotterIV.addEventListener("click", function () {
        ...
        inputNombreLibro.value = "Harry Potter y el cáliz de fuego";
        inputAutorLibro.value = "J. K. Rowling";
    });
    ...
    silberI.addEventListener("click", function () {
        ...
        inputNombreLibro.value = "Silber: El primer libro de los sueños";
    ...
    silberII.addEventListener("click", function () {
        ...
        inputNombreLibro.value = "Silber: El segundo libro de los sueños";
        inputAutorLibro.value = "Kerstin Gier";
    });
    ...
    silberIII.addEventListener("click", function () {
        ...
        inputNombreLibro.value = "Silber: El tercer libro de los sueños";
        inputAutorLibro.value = "Kerstin Gier";
    });
    ...
    edipoRey.addEventListener("click", function () {
        ...
        inputAutorLibro.value = "Sófocles";
    });
    ...
    juventudEnExtasis.addEventListener("click", function () {
        ...
        inputNombreLibro.value = "Juventud en éxtasis";
        inputAutorLibro.value = "Carlos Cuauhtémoc Sánchez";
    });
    ...
    elEntreNosotras.addEventListener("click", function () {
        ...
        inputNombreLibro.value = "Él entre nosotras";
    ...
    laLeccionDeAugust.addEventListener("click", function () {
        ...
        inputNombreLibro.value = "La lección de August";
    ...
    carinoCuantoTeOdio.addEventListener("click", function () {
        ...
        inputNombreLibro.value = "Cariño, cuánto te odio";
    ...
    miPapaEsUnHombrePajaro.addEventListener("click", function () {
        ...
        inputNombreLibro.value = "Mi papá es un hombre pájaro";
